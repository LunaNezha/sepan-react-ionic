interface Resources {
  "translations": {
    "app_title": "سپان",
    "app_complete_title": "سامانه پذیرش الکترونیکی نسخه",
    "titles": {
      "dashboard": "پیشخوان",
      "account_status": "حساب کاربری",
    ...
    "validations": {
      ...
      "national_code_format": "قالب کد ملی نامعتبر است.",
      "requireds": {
        "id_tracking": "وارد کردن شماره پیگیری الزامی می باشد.",
      ...
      "minimum": {
        ...
        "password": "رمز عبور باید 6 کاراکتر یا بیشتر باشد."
      },
      "maximum": {
        "national_code": "کد ملی باید 30 کاراکتر یا کمتر باشد."
      }
    },
    "buttons": {
      "register": "ثبت نام",
    ...
    "menus": {
      ...
      "rare_drugs": "داوهای کمیاب",
      "settings": "تنظیمات",
      "patients": "بیماران",
      "prescription_acceptance_list": "لیست پذیرش نسخه",
      "temporary_prescriptions": "نسخه های موقت",
      "prescription_delivery": "تحویل نسخه",
      "prescription_archive": "آرشیو نسخ",
      "sms": "پیامک ها",
      "news": "اخبارها و رویدادها",
      "guide": "راهنما"
    },
    "globals": {
